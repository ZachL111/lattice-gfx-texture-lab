...
`lattice-gfx-texture-lab` is centered on graphics work in Dart. The technical target is: Design a Dart verification harness for texture systems, covering format conversion, round-trip fixtures, and failure-oriented tests.
...
The score is deterministic. The current threshold is 180. Risk has a penalty of 4, latency has a penalty of 2, and weight contributes a bonus of 5.
