"""Regression checks for the lattice-gfx-texture-lab casebook."""
...
from casebook.harness import assert_expected, lattice_gfx_texture_lab_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lattice_gfx_texture_lab_summary(), assert_expected())
